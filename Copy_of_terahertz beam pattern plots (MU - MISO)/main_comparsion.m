...
hold on;
grid on;
plot(dist, pattern_BD_dist_db(:,k), 'Color', colors(1,:));
plot(dist, pattern_SLNR_dist_db(:,k), 'Color', colors(2,:));
...
hold on;
grid on;
plot(ang_deg, pattern_BD_ang_db(:,k), 'Color', colors(1,:));
plot(ang_deg, pattern_SLNR_ang_db(:,k), 'Color', colors(2,:));
